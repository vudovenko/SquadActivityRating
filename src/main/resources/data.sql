...
values ('Универсиада1', 'Спортивное событие', 'Екатеринбург', '2021-04-23 09:50:00', '01:30', 1),
...
values (1, 4, 1), (1, 4, 2), (1, 5, 4), (1, 5, 3), (1, 6, 1), (2, 6, 2), (2, 8, 1), (3, 4, 2), (3, 8, 1),
       (6, 4, 4), (6, 4, 4), (6, 5, 2), (6, 5, 3), (6, 6, 1), (6, 6, 4), (6, 7, 4);
-- todo добавить тестовые данные для всех типов мероприятий и для всех отрядов
insert into event_to_squad_user (event_id, squad_user_id)
values (10, 2), (10, 4), (10, 5), (10, 10), (10, 11), (10, 12),
...
values (1, 10, 'Отличное мероприятие!'), (2, 8, 'Хорошее мероприятие!'), (3, 3, 'Мне почему-то не понравилось :('),
       (12, 9, 'Отличное мероприятие!'), (13, 9, 'Отличное мероприятие!'), (14, 10, 'Отличное мероприятие!'), (15, 7, 'Хорошее мероприятие!'),
       (16, 9, 'Отличное мероприятие!'), (18, 7, 'Хорошее мероприятие!'), (21, 7, 'Хорошее мероприятие!'),
       (22, 8, 'Хорошее мероприятие!'), (23, 9, 'Отличное мероприятие!'), (25, 8, 'Хорошее мероприятие!'),
       (28, 6, 'Не очень понравилось'), (29, 5, 'Не очень понравилось'), (30, 8, 'Хорошее мероприятие!'), (32, 10, 'Отличное мероприятие!'),
       (35, 8, 'Мне почему-то не понравилось :('), (36, 10, 'Отличное мероприятие!'), (37, 1, 'Плохое мероприятие!');